...
so_file_path = os.path.abspath("15/")
...
slider_inputs = [
    ...
    # ("ellipse", [-0.2, 0.2, np.random.random(), 0.15, 0.10]),
    # ("superellipse", [0.0, 0.6, np.random.random(), 0.13, 0.08, 7]),
    # ("rightpolygon", [0.3, 0.6, np.random.random(), 0.13, 3]),
    # ("smoothrightpolygon", [-0.3, 0.6, np.random.random(), 0.13, 5]),
]
